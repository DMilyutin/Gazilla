...
import com.gazilla.mihail.gazillaj.presenters.MainPresenter
import com.gazilla.mihail.gazillaj.presenters.NotificationPresenter
...
class MainActivity : MvpAppCompatActivity(), MainView, CardFragment.UpdateBalance {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgAccount.setOnClickListener {
            ...
            //intent = Intent(this@MainActivity, FirstTipsActivity::class.java)
